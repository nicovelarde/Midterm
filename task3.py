...
plt.plot(predictions_df["x_future_state"], label="Predicted x1ₖ₊₁", linestyle ='--' )
plt.xlabel("Sample")
plt.ylabel("x")
plt.legend()
plt.show()
...
plt.figure(figsize=(10, 5))
plt.plot(y_test[:, 1], label="Actual Vₖ₊₁")
plt.plot(predictions_df["v_future_state"], label="Predicted Vₖ₊₁",linestyle ='--')
plt.xlabel("Sample")
plt.ylabel("v")
plt.legend()
plt.show()
