...
x1_tree = RegressionTree(X_train, y_train[:, 0], max_depth=5, control_by="depth")
x2_tree = RegressionTree(X_train, y_train[:, 1], max_depth=5, control_by="depth")
